...
for name, from_person in [("sara", from_sara), ("chris", from_chris)]:
	...
	#words = str.replace("sara", "").replace("shackleton", "").replace("chris", "").replace("germani", "")
...
print 'word data[152] : ', word_data[152]
...
print 'transformer : ', transformer.get_feature_names()

print len(transformer.get_feature_names())
print transformer.get_feature_names()[34596]
